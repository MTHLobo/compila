...
public class MinhaLinguagemParser extends Parser {
	...
	public static final int
		...
		MULT=18, DIV=19, SOMA=20, SUB=21, IGUAL=22, DIFERENTE=23, MAIOR=24, MENOR=25, 
		MAIOR_IGUAL=26, MENOR_IGUAL=27, E_LOGICO=28, OU_LOGICO=29, ID=30, NUMERO=31, 
		STRING_VAL=32, WS=33, COMENTARIO=34;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"E_LOGICO", "OU_LOGICO", "ID", "NUMERO", "STRING_VAL", "WS", "COMENTARIO"
		};
	}
	...
	public final BlocoContext bloco() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1073761920L) != 0)) {
				{
				{
				setState(42);
				comando();
	...
	public static class ExprRelacionalContext extends ExpressaoContext {
		...
		public TerminalNode DIFERENTE() { return getToken(MinhaLinguagemParser.DIFERENTE, 0); }
		...
		public TerminalNode MAIOR_IGUAL() { return getToken(MinhaLinguagemParser.MAIOR_IGUAL, 0); }
		public TerminalNode MENOR_IGUAL() { return getToken(MinhaLinguagemParser.MENOR_IGUAL, 0); }
