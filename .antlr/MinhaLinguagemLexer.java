...
public class MinhaLinguagemLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "TIPO", "NAO", "MULT", 
			"DIV", "SOMA", "SUB", "IGUAL", "DIFERENTE", "MAIOR", "MENOR", "MAIOR_IGUAL", 
			"MENOR_IGUAL", "E_LOGICO", "OU_LOGICO", "ID", "NUMERO", "STRING_VAL", 
			"WS", "COMENTARIO"
		};
	}
